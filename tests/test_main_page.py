...
class TestMainPage:
    ...
    @pytest.mark.smoke
    def test_get_header_auth_login_text(self, main_page_open, driver):
    ...
    @pytest.mark.smoke
    def test_get_header_auth_login_color(self, main_page_open, driver):
    ...
    @pytest.mark.smoke
    def test_get_header_auth_signup_text(self, main_page_open, driver):
    ...
    @pytest.mark.smoke
    def test_get_header_auth_signup_color(self, main_page_open, driver):
