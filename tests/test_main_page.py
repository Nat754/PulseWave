...
from tests.constant import MAIN_PAGE_HOME, TEXT_SIGNUP, TEXT_LOGIN, TEXT_SIGNUP_HEADER, BUTTON_COLOR, MAIN_PAGE_URL, \
    LICENSE_TITLE, LICENSE_LINK, EMAIL_TEXT, YEAR_COOPERATION, COOKIES_TEXT, COOKIES, COOKIES_BUTTON, TEXT_COLOR, \
    ALL_TIME, FIRST_SAFETY, USEFUL_INTERFACE, EMAIL_TEXT_HOVER, TEXT_SIZE,  TERMS_OF_SERVICE, FULL_FUNCTIONALITY, \
    ONE_APP, PULSEWAVE_SIZE, TITLE_COLOR, MAIN_PAGE_TITLE, BUTTON_TEXT_SIZE, BUTTONS_URL, BUTTONS, ITEMS, \
    ITEMS_PULSEWAVE_COLOR, ITEMS_TEXT
