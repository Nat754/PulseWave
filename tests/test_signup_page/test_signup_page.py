...
class TestSignupPage:
    ...
    @pytest.mark.smoke
    def test_signup_with_weak_password(self, signup_page_open, driver):
        ...
        text = signup_page_open.get_invalid_password_message()
        with allure.step('Проверка сообщения о слабом пароле'):
            assert text == self.msg.INVALID_PASSWORD_MSG, 'Нет сообщения о слабом пароле'
